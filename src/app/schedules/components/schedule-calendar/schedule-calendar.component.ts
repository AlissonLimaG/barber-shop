...
import { ImplDialogManagerService } from '../../../services/idialog-manager.service';
...
export class ScheduleCalendarComponent implements OnDestroy, AfterViewInit, OnChanges {
  ...
  constructor(@Inject(SERVICES.DIALOG) private readonly dialogManagerService: ImplDialogManagerService) { }
